      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-20 relative z-10 w-full">
        ...
        <div className="glass-panel border border-white/5 rounded-3xl p-8 sm:p-12 bg-white/2 backdrop-blur-2xl space-y-8 text-left text-slate-300 text-xs sm:text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <p>
              At OVO.AI, we prioritize the privacy and security of your email workspaces. This Privacy Policy describes how we collect, store, decrypt, and process data when you connect your Google/Gmail account to our platform.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              When you authenticate with Google OAuth, we access and synchronize:
            </p>
            <ul className="list-disc pl-6 space-y-1.5 text-slate-400">
              <li><strong>Google Profile Data</strong>: Your primary email address, user ID, and auth tokens to manage your workspace mapping.</li>
              <li><strong>Gmail Threads & Emails</strong>: Email headers, subjects, body texts, attachments metadata, and snippets. We sync these to organize them in your local Smart Inbox.</li>
              <li><strong>Semantic Vector Embeddings</strong>: Chunks of email texts are converted into 768-dimensional numerical vectors using embedding models (e.g. Gemini/NVIDIA) to enable natural language search in your workspace.</li>
            </ul>
          </section>
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-1.5 text-slate-400">
              <li><strong>AES-256 Symmetric Encryption</strong>: All Google OAuth access and refresh tokens are fully encrypted using AES-256 (via Pydantic cryptography) before storage in the database.</li>
              <li><strong>Data Isolation</strong>: Your synced emails, threads, and vector embeddings are logically segregated by `account_id` and `user_id` so that other users cannot access your data.</li>
            </ul>
          </section>
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-1.5 text-slate-400">
              ...
              <li>Generating automated email summaries and drafting thread responses.</li>
              <li>Running context-aware RAG vector search to let you search and query your inbox semantically.</li>
            </ul>
            <p className="mt-2 text-slate-400">
              We **never** sell, rent, or share your email content with advertisers, third-party brokers, or external entities.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Under privacy regulations (including GDPR and CCPA), you have the right to access, export, correct, or request the deletion of your personal data. You can perform these actions or contact our support team to request database wipes.
            </p>
          </section>
